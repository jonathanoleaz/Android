...
public class ObtenerRegistroAsyncTask extends AsyncTask<String, Integer, String> {

    private String userdb,passdb,urldb;
    Activity mWeakActivity;


    public ObtenerRegistroAsyncTask(String url,String user, String pass, Activity activity){
        this.urldb=url;
        this.userdb=user;
        this.passdb=pass;
