...
public class AddActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    public void onClick(View v) {
        ...
        if (v.getId() == R.id.buttonAceptarNuevo) {
            ...
            InsertarRegistro insertarRegistro=new InsertarRegistro(user, pass, this);
            insertarRegistro.execute("INSERT INTO evento (nombreEvento, inicio, fin, observaciones) VALUES (?, ?, ?, ?)", nombreTxt.getText().toString(), inicioTxt.getText().toString(), finTxt.getText().toString(), observsTxt.getText().toString());
