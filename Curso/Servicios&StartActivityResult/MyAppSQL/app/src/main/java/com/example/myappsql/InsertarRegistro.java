...
public class InsertarRegistro extends AsyncTask<String, Integer, String> {

    private String userdb,passdb;
    Activity mWeakActivity;


    public InsertarRegistro(String user, String pass, Activity activity){
        this.userdb=user;
        this.passdb=pass;
        ...
        protected String doInBackground(String... strings) {
            String url="jdbc:mysql://192.168.1.67:3306/eventosescom";
