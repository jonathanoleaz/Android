...
public class ActivityRestar extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        this.findViewById(R.id.buttonCalcularResta).setOnClickListener(this);
    }
    ...
    public void onClick(View v) {
        ...
        resultIntent.putExtra("resultado_resta", resultado);
